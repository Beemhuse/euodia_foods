    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center h-full bg-black bg-opacity-50">
        <div className="text-center text-white p-4 mt-8 sm:mt-4 md:mt-0">
          ...
          <p className="text-sm sm:text-lg md:text-2xl mb-6">Food is what we eat to stay alive and healthy. It comes in many different forms and flavors, from fruits and vegetables to meats and grains.</p>
